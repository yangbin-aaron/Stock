...
//		}
	...
	public void showRefreshTime(){
		...
		Long space = temp - spaceTime;
		long days = space / (1000 * 60 * 60 * 24);  
		long hours = (space % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60);  
		long minutes = (space % (1000 * 60 * 60)) / (1000 * 60);  
		long seconds = (space % (1000 * 60)) / 1000; 
		StringBuffer sb = new StringBuffer("更新于 ");
		if(days>0){
